...
const Header = () => {
  ...
  return (
    ...
    <Link to='/' className='flex items-center gap-1'>
      ...
      <span className='font-bold text-xl'>airbnbC</span>
    </Link>
    ...
    <Link to={user ? '/account' : '/login'} className='flex items-center border gap-2 border-gray-300 rounded-full py-2 px-4'>
        ...
        <div className='bg-gray-500 text-white rounded-full border border-gray-500'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 relative top-1 overflow-hidden">
